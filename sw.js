...
var CACHE = "deaddance-v713-2026-08-06";
...
self.addEventListener("install", function (e) {
  e.waitUntil(
    ...
    // NOTE: intentionally NO self.skipWaiting() here — a newly deployed SW now WAITS
    // instead of silently taking over. The client (dd_swupdate.js / index.html banner)
    // shows "🔄 New version — tap to refresh"; the message handler below runs
    // skipWaiting() on the user's tap. If ignored, the waiting worker still activates
    // naturally once all tabs close. Manual updaters (e.g. dd_health.js) also post
    // {type:'SKIP_WAITING'} and keep working unchanged.
  );
});
