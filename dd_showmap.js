...
(function () {
  ...
  var SHOWS = [
    ...
    // ── John Kimock (Steve's son, drums — summer run billed w/ Oteil & Friends) ──
    { band: "John Kimock · Oteil & Friends", venue: "Gratefulfest", city: "Garrettsville, OH", date: "2026-07-24", real: true },
    { band: "John Kimock · Oteil & Friends", venue: "JamPacked Festival", city: "Richmond, VA", date: "2026-08-01", real: true },
    { band: "John Kimock · Oteil & Friends", venue: "French Broad River Brewery", city: "Asheville, NC", date: "2026-08-02", real: true },
    { band: "John Kimock · Oteil & Friends", venue: "The Muse", city: "Nantucket, MA", date: "2026-08-04", real: true },
    { band: "John Kimock · Oteil & Friends", venue: "Tree House Brewing – Summer Stage", city: "Deerfield, MA", date: "2026-08-06", real: true },
    { band: "John Kimock · Oteil & Friends", venue: "Nashua Center for the Arts", city: "Nashua, NH", date: "2026-08-07", real: true },
    { band: "John Kimock · Oteil & Friends", venue: "Stateside Amphitheatre, Jay Peak", city: "Jay, VT", date: "2026-08-08", real: true },
    { band: "John Kimock · Oteil & Friends", venue: "Lincoln Hill Farms", city: "Canandaigua, NY", date: "2026-08-09", real: true },
  ...
  try {
    [window.dealMapRows, window.hotSauceMapRows, window.kgbMapRows, window.cncMapRows, window.stageFillMapRows].forEach(function (fn) {   // kgbMapRows/cncMapRows: Karl's Garcia Band + Crickets and Cicadas · stageFillMapRows: only on the StageFill national map; undefined (no-op) on the DeadDance home map
      if (!fn) return;
